...
module.exports = function() {
  return {
    restrict: 'E',
    link: function($scope, el) {
      var barHeight, barWidth, bottomLabels, capDiv, capacityG, currSize, growth, labels, maxSize, nodeRadius, nodes, nodesG, percentFormat, resilienceFormat, siBytesFormat, svg, tier, tierData, topLabels, _ref;
